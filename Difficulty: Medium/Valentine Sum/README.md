<h2><a href="https://www.geeksforgeeks.org/problems/valentine-sum--141631/1?page=9&category=Tree&sortBy=submissions">Valentine Sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Cupid wants to strike maximum houses in Geek Land on Valentine's Day. The houses in Geek Land are arranged in the form of a <strong>binary tree</strong>. Cupid is standing at <strong>target</strong> node initially.&nbsp;<br>
